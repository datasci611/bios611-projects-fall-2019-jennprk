...
p1 <- cowplot::plot_grid(race.p, ethnicity.p, nrow=2, align="v")
p1

ggsave("../results/plots/RaceEthnicityPlot.png", p1)
```
...
We can see that considering the age distribution of the patients, there is a higher chance of clients in their 20s to have better chance in improving their income status. We can guess that there are more demands for young workers.
...
left_join(dat4.2, dat1 %>% select(ClientID, AgeGroup), by="ClientID") %>%
  mutate(AgeGroup = factor(AgeGroup, levels=c("10s","20s","30s","40s","50s","60s","70s"))) -> dat4.2
```
...
(ggplot(dat4.2, aes(x=Race,y=ttl_lengthofstay, color=Race)) +
  geom_boxplot(outlier.shape = NA) +
  labs(title= "Total length of Stay by Race Groups",
       y = "Total Length of Stay", x = "Race Group") +
  coord_flip() +
...
(ggplot(dat4.3, aes(x=Race,y=ttl_lengthofstay, color=Race)) +
  geom_boxplot(outlier.shape = NA) +
  labs(title= "Total length of Stay by Race Groups (Race Info Known)",
       y = "Total Length of Stay", x = "Race Group") +
  coord_flip() +
...
(ggplot(dat4.2, aes(x=AgeGroup,y=ttl_lengthofstay, color=AgeGroup)) +
  geom_boxplot(outlier.shape = NA) +
  labs(title= "Total length of Stay by Age Groups",
       y = "Total Length of Stay", x = "Age Group") +
  coord_flip() +
...
(ggplot(dat4.2, aes(x=Gender,y=ttl_lengthofstay, color=Gender)) +
  geom_boxplot(outlier.shape = NA) +
  labs(title= "Total length of Stay by Gender Groups",
       y = "Total Length of Stay", x = "Gender Group") +
  coord_flip() +
...
(ggplot(dat4.2, aes(x=Veteran,y=ttl_lengthofstay, color=Veteran)) +
  geom_boxplot(outlier.shape = NA) +
...
(ggplot(dat4.3, aes(x=Veteran,y=ttl_lengthofstay, color=Veteran)) +
  geom_boxplot(outlier.shape = NA) +
  labs(title= "Total length of Stay by Veteran Status (Veteran status Info Known)",
       y = "Total Length of Stay", x = "Veteran status") +
  coord_flip() +
...
(ggplot(dat4.2, aes(x=Race,y=visitnum, color=Race)) +
  geom_boxplot(outlier.shape = NA) +
  labs(title= "Number of visits by Race Groups",
       y = "Number of visits", x = "Race Group") +
  coord_flip() +
  scale_x_discrete(limits = rev(levels(dat4.2$Race))) +
  annotate("text",  x=Inf, y = Inf, label = paste("p=", round(kwrace,3)) , vjust=1, hjust=1) +
  ylim(0.7,3.5) +
...
kruskal.test(visitnum ~ Race, data = dat4.3) -> t

dat4.3 %>%
  group_by(Race) %>%
  summarise(mean(visitnum))
ggplot(dat4.3, aes(group=Race,x=visitnum, color=Race)) +
  geom_bar()

(ggplot(dat4.3, aes(x=Race,y=visitnum, color=Race)) +
  geom_boxplot(outlier.shape = NA) +
  labs(title= "Number of visits by Race Groups (Race Info Known)",
       y = "Number of visits", x = "Race Group") +
  coord_flip() +
  scale_x_discrete(limits = rev(levels(dat4.3$Race))) +
  annotate("text",  x=Inf, y = Inf, label = paste("p=", round(kwrace,3)) , vjust=1, hjust=1) +
...
paste(pwrace[pwrace$p<0.05,"comparison"], collapse = ", ")
```
...
(ggplot(dat4.2, aes(x=AgeGroup,y=visitnum, color=AgeGroup)) +
  geom_boxplot(outlier.shape = NA) +
  labs(title= "Number of Visits by Age Groups",
       y = "Number of Visits", x = "Age Group") +
  coord_flip() +
  scale_x_discrete(limits = rev(levels(dat4.2$AgeGroup))) +
  annotate("text",  x=Inf, y = Inf, label = paste("p=", round(kwage,3)) , vjust=1, hjust=1) +
  ylim(0.7,3) +
...
Hence, we can see that clients in their 70s tend to have a significantly lower recurrence.
...
(ggplot(dat4.2, aes(x=Gender,y=visitnum, color=Gender)) +
  geom_boxplot(outlier.shape = NA) +
  labs(title= "Number of Visits by Gender Groups",
       y = "Number of Visits", x = "Gender Group") +
  coord_flip() +
  scale_x_discrete(limits = rev(levels(dat4.2$Gender))) +
  annotate("text",  x=Inf, y = Inf, label = paste("p=", round(kwgen,3)) , vjust=1, hjust=1) +
  ylim(0.7,4) +
...
(ggplot(dat4.2, aes(x=Veteran,y=visitnum, color=Veteran)) +
  geom_boxplot(outlier.shape = NA) +
  labs(title= "Number of Visits by Veteran Status",
       y = "Number of Visits", x = "Veteran Status") +
  coord_flip() +
  scale_x_discrete(limits = rev(levels(dat4.2$Veteran))) +
  annotate("text",  x=Inf, y = Inf, label = paste("p=", round(kwvet,3)) , vjust=1, hjust=1) +
  ylim(0.7,4) +
...
(ggplot(dat4.3, aes(x=Veteran,y=visitnum, color=Veteran)) +
  geom_boxplot() +
  labs(title= "Number of Visits by Veteran Status (Veteran status Info Known)",
       y = "Number of Visits", x = "Veteran status") +
  coord_flip() +
  scale_x_discrete(limits = rev(levels(dat4.3$Veteran))) +
  annotate("text",  x=Inf, y = Inf, label = paste("p=", round(kwvet,3)) , vjust=1, hjust=1) +
